...
const MobileBottomNavigation = ({ currentTab, setCurrentTab }: { currentTab: string; setCurrentTab: (tab: string) => void }) => {
  const tabs = [
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-charcoal border-t border-steel/20 z-50">
...
export default function MobileSettings() {
  ...
  return (
    <div className="min-h-screen bg-charcoal text-white pb-16">
      {/* Mobile Header */}
      <header className="bg-charcoal border-b border-steel/20 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <SettingsIcon className="w-6 h-6 text-gold mr-3" />
            ...
            <Card className="bg-dark-card border-steel/20">
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    <DialogContent className="bg-dark-card border-steel/20 max-h-[90vh] overflow-y-auto scrollbar-hide w-[calc(100vw-2rem)] max-w-md">
                      <DialogHeader>
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            ...
                            {previewUrl ? (
                              ...
                              <div className="w-24 h-24 bg-steel/20 rounded-full flex items-center justify-center border border-steel/40">
                            ...
                            <div className="flex space-x-2">
                              <Button
                                ...
                                className="flex-1 border-steel/30 text-white hover:bg-steel/20"
                              >
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    ...
                                    className="bg-charcoal border-steel/30 text-white placeholder-steel focus:border-gold focus:ring-gold"
                                  />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Textarea
                                    ...
                                    className="bg-charcoal border-steel/30 text-white placeholder-steel focus:border-gold focus:ring-gold resize-none scrollbar-hide"
                                    rows={4}
                                  />
                                </FormControl>
                                <FormMessage />
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <Select onValueChange={field.onChange} value={field.value}>
                                  <FormControl>
                                    <SelectTrigger className="bg-charcoal border-steel/30 text-white">
                                      <SelectValue placeholder="Select timezone" />
                                    </SelectTrigger>
                                  </FormControl>
                                  <SelectContent className="bg-charcoal border-steel/30">
                          ...
                          <div className="flex justify-end space-x-2 pt-4">
                            <Button
                              ...
                              className="border-steel/30 text-white hover:bg-steel/20"
                            >
                              Cancel
                            </Button>
                            <Button
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-4">
                  <div className="w-16 h-16 bg-steel/20 rounded-full flex items-center justify-center flex-shrink-0">
                    {user?.photoUrl ? (
                      <img
                        src={user.photoUrl}
                        alt="Profile"
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Dialog open={isChangingPassword} onOpenChange={setIsChangingPassword}>
                    ...
                    <DialogContent className="bg-dark-card border-steel/20 w-[calc(100vw-2rem)] max-w-md">
                      <DialogHeader>
                              ...
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input
                                    type="password"
                                    {...field}
                                    className="bg-charcoal border-steel/30 text-white"
                                  />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
      ...
      <MobileBottomNavigation currentTab={currentTab} setCurrentTab={setCurrentTab} />
    </div>
  );
}