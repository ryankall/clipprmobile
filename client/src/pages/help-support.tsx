...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "You can cancel your Premium subscription anytime from Settings → Subscription Management. Your premium access will continue until the end of your current billing period.",
    category: "Premium & Billing",
  ...
  },
  {
    ...
    answer:
      "If you're within your first 30 days of Premium, you can request a full refund from Settings → Subscription Management. The refund will be processed immediately and you'll be downgraded to Basic plan.",
    category: "Premium & Billing",
    icon: <CreditCard className="w-4 h-4" />,
  },
  {
    ...
    answer:
      "Basic plan allows 15 appointments per month. Premium plan offers unlimited appointments. The counter resets on the first day of each month.",
    category: "Features",
  ...
  },
  {
    ...
    answer:
      "Go to the Clients page to add, edit, and track your client information. You can store contact details, service history, and notes for each client.",
    category: "Features",
  ...
  },
  {
    ...
    answer:
      "Your public booking link is available in Settings → Public Booking Link. Share this with clients so they can book appointments directly with you.",
    category: "Features",
  ...
  },
  {
    ...
    answer:
      "Premium users can set custom working hours for each day of the week in Settings → Working Hours. Basic users have standard working hours.",
    category: "Features",
  ...
  },
  {
    ...
    answer:
      "Basic plan includes 50MB of photo storage. Premium plan includes 1GB of storage for your portfolio gallery.",
    category: "Features",
    icon: <Settings className="w-4 h-4" />,
  },
  {
    ...
    answer:
      "SMS confirmations are sent to clients when appointments are booked. Basic plan includes 15 SMS per month, Premium offers unlimited SMS.",
    category: "Features",
    icon: <MessageSquare className="w-4 h-4" />,
  },
  {
    ...
    answer:
      "Yes, we use industry-standard encryption and security measures. Your client data and payment information are protected with bank-level security.",
    category: "Security",
    icon: <Shield className="w-4 h-4" />,
  },
];
  ...
  const handleSupportSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description:
          "Failed to open email client. Please email us directly at customersupport@kall-e.com",
        variant: "destructive",
      });
    } finally {
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-white text-sm leading-relaxed">
                  Try Clippr Pro risk-free for 30 days. If you're not satisfied,
                  request a full refund — no hassle. You can also cancel your
                  subscription anytime directly from the Settings page.
                </p>
